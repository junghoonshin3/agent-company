...
- CEO Plan Mode. 직원 실행 전에 목표, 성공 기준, 참여 역할, 검증 계획을 사용자에게 먼저 제안합니다.
- 필요한 직원만 호출. 서비스 기획자, 리서치 담당자, UI/UX 디자이너, 프로젝트 아키텍트, 풀스택 개발자, QA 엔지니어, 릴리즈 담당자, 기록·지식관리 담당자 중 필요한 역할만 선택합니다.
...
2. CEO가 필요한 직원 역할과 합의 정책을 포함한 계획을 제안합니다.
...
8. 합의가 나면 `close_meeting`으로 요약, 합의, 남은 질문, 다음 액션을 기록합니다.
